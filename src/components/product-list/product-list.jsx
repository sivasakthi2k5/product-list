          ...
          <div className="container">
            <div className="row">
              { productList.map((product, index) => {
                const productImg = product.getIn(["hero", "href"], "");
                const productLink = product.getIn(["links", "www"], "");
                ...
                return (
                  <div className="col-lg-4 col-sm-12 product-list__product-image-container" key={ index }>
                    <div className="product-list__product-image-block">
                      ...
                      <div className="product-list__product-name"><a href={ productLink }>{ productName }</a></div>
